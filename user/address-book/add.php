    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Add a new delivery address to your address book</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
                <form method="POST" action="" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="label" value="Home"
                               class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-green-500 focus:border-green-500"
                    ...
                    <div>
                        ...
                        <textarea name="delivery_instructions" rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-green-500 focus:border-green-500"
                                  placeholder="e.g., Ring doorbell twice, leave at front door, security code is 1234..."></textarea>
                        <p class="text-sm text-gray-500 mt-1">Optional: Provide specific delivery instructions</p>
                    </div>

                    <div class="flex items-center">
                        <input type="checkbox" name="default_for_shipping" id="default_for_shipping" class="text-green-600 focus:ring-green-500 rounded">
